        ...
        <div className="d-flex justify-content-center align-items-center">
          <div style={{ maxWidth: "1000px" }}>
            ...
            <section id="important-dates" className="scroll-mt-24">
              <div>
                <div className="overflow-x-scroll px-4 mt-10 scroll-mt-28">
                  <h2 className="m-0 mb-4 text-xl sm:text-2xl">
                    Important Dates for IIT JEE Main 2025
                  </h2>
                  <div className="space-y-10">
                    <div>
                      <table className="border-2 border-gray-200 table-fixed">
                        <thead>
                          <tr>
                            <th className="border-2 border-gray-200 p-2">
                              Event Details
                            </th>
                            <th className="border-2 border-gray-200 p-2">
                              Important Dates JEE Main (Tentative)
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                        ...
                        <tbody>
                          <tr>
                            <td className="border-2 border-gray-200 p-2">
                              Availability of JEE Main 2025 Brochure
                            </td>
                            <td className="border-2 border-gray-200 p-2">
                              November, 2025
                            </td>
                        ...
                        <tbody>
                          <tr>
                            <td className="border-2 border-gray-200 p-2">
                              Start Date of JEE Main 2025 Registration
                            </td>
                            <td className="border-2 border-gray-200 p-2">
                              <p> January Session- November 2024 </p>{" "}
                              <p> April Session - Last week of March 2025. </p>
                            </td>
                          </tr>
                        </tbody>
                        <tbody>
                          <tr>
                            <td className="border-2 border-gray-200 p-2">
                              JEE Main 2025 Application form Last Date
                            </td>
                            <td className="border-2 border-gray-200 p-2">
                              <p> January Session- December 2024 </p>{" "}
                              <p> April Session- April 2025 </p>
                            </td>
                          </tr>
                        </tbody>
                        <tbody>
                          <tr>
                            ...
                            <td className="border-2 border-gray-200 p-2">
                              <p> January Session- January 2025 </p>{" "}
                              <p> April Session- April 2025 </p>
                            </td>
                          </tr>
                        </tbody>
                        <tbody>
                          <tr>
                            <td className="border-2 border-gray-200 p-2">
                              JEE Main 2025 Exam Date (1st &amp; 2nd Session)
                            </td>
                            <td className="border-2 border-gray-200 p-2">
                              <p> January Session- January 2025 </p>{" "}
                              <p> April Session- April 2025</p>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="border-2 border-gray-200 p-2">
                              <p> January Session- February 2025 </p>{" "}
                              <p> April Session- April 2025 </p>
                            </td>
                          </tr>
                        </tbody>
                        <tbody>
                          <tr>
                            <td className="border-2 border-gray-200 p-2">
                              Commencement of IIT JEE 2025 counseling
                            </td>
                            <td className="border-2 border-gray-200 p-2">
                              To be announced
                            </td>
                ...
                <div className="overflow-x-scroll px-4 mt-10">
                  ...
                  <table className="border-2 border-gray-200 table-fixed">
                    ...
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          JEE 2025 Admit Card Release date
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                          <p> January Session- To Be Notified </p>{" "}
                          <p> April Session- To Be Notified </p>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          JEE Main Admit Card download official website
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                    ...
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          Details required to login and get JEE Main Admit Card
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                          <ul>
                            {" "}
                            <li> Application Number </li>{" "}
                            <li> Date of Birth </li> <li> Password </li>
                          </ul>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          JEE Main 2025 exam date by NTA
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                          <p> Session 1: Last Week of January, 2025 </p>{" "}
                          <p> Session 2: Last Week of April, 2025 </p>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          Details required to login and get JEE admit card 2025
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                          <ul>
                            <li>Application number</li> <li>Date of birth</li>{" "}
                            <li>Security pin</li>
                          </ul>
                        </td>
                      </tr>
                    ...
                    <tbody>
                      <tr>
                        <td className="border-2 border-gray-200 p-2">
                          JEE Main login admit card 2025 direct link
                        </td>
                        <td className="border-2 border-gray-200 p-2">
                          To be Notified when admit card is out
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        ...
                        <td className="border-2 border-gray-200 p-2">
                          <p>
                            Address - C20 1A/8, Sector - 62, IITK outreach
                            centre, Noida - 201309.
                          </p>{" "}
                          <p>
                          ...
                          <p>
                            Email ID -{" "}
                            <a href="mailto:jeemain-nta@govin">
                              jeemain-nta@gov.in
                            </a>
                          </p>
                        </td>
            ...
            <section id="exam-pattern" className="scroll-mt-24">
              <div>
            ...
            <section id="iit-colleges" className="scroll-mt-24">
              <div>
                <div className="px-4 mt-10 scroll-mt-28">
                  <h2 className="m-0 mb-4 text-xl sm:text-2xl">
                    India's Top IIT Colleges with Fees & Average Salary
                  </h2>
                  <div className="space-y-6">
                    <div>
                      <div className="space-y-4">
                        <p>
                          Here are all the top IIT Engineering colleges in India
                          and their tuition fees with the average package you
                          can get after 4 years:
                        </p>
                        <table className="border-2 border-gray-200 table-fixed">
                          <thead>
                            <tr>
