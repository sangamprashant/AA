...
const trustReasons: TrustReason[] = [
  {
    icon: "/review/parents/trust/satisfaction.png",
  ...
  {
    icon: "/review/parents/trust/screening.png",
  ...
  {
    icon: "/review/parents/trust/student.png",
  ...
  {
    icon: "/review/parents/trust/funding.png",
    title: "Affordable",
    description:
